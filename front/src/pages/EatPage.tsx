...
import { Error, Button, PopupMessage, InputDatePickerConsumer, Input, TableEatProduct, TableEatFood } from "../components";
import { useEat } from "../hooks";
import { useState } from "react";
import { useNavigate } from "react-router-dom"; // Correção: adicionei o import do useNavigate
...
export default function EatPage() {
  ...
  const navigate = useNavigate(); // Correção: useNavigate adicionado aqui
  ...
  const handleLogout = () => {
    navigate("/logout"); // Correção: Agora o navigate funciona corretamente
  };
  ...
  return (
    <WrapperSld>
      <Button label="Deslogar" click={handleLogout} /> {/* Botão de deslogar */}
